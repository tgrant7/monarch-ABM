 ...
 *
 */
public class MonarchStyle implements MarkStyle<Monarch>{
	 ...
	 */
	@Override
	public PlaceMark getPlaceMark(Monarch monarch, PlaceMark mark) {
	 ...
	 */
	@Override
	public double getElevation(Monarch monarch) {
			return 0;
		}
	 ...
	 */
	@Override
	public WWTexture getTexture(Monarch monarch, WWTexture texture) {
	 ...
	 */
	@Override
	public double getScale(Monarch monarch) {
			return 1;
	}

	@Override
	public double getHeading(Monarch monarch) {
		return 0;
	}
	 ...
	 */
	@Override
	public String getLabel(Monarch monarch) {
		return "";
	}

	@Override
	public Color getLabelColor(Monarch monarch) {
		return Color.ORANGE;
	}
	 ...
	 */
	@Override
	public Offset getLabelOffset(Monarch monarch) {
		return labelOffset;
	}

	@Override
	public Font getLabelFont(Monarch obj) {
		return null;
	}
	 ...
	 */
	@Override
	public double getLineWidth(Monarch monarch) {
			return 0;
	}

	@Override
	public Material getLineMaterial(Monarch obj, Material lineMaterial) {
	...
	@Override
	public Offset getIconOffset(Monarch obj) {
